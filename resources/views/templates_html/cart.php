            ...
            <div class="col-md-4">
                ...
                <div class="single-sidebar">
                    ...
                    <div class="thubmnail-recent">
                        <img src="resources/img/product-1.jpg" class="recent-thumb" alt="">
                                ...
                                <ul class="products">
                                    <li class="product">
                                        <a href="single-product.php">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="resources/img/product-2.jpg">
                                    ...
                                    <li class="product">
                                        <a href="single-product.php">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="resources/img/product-4.jpg">
                                            <h3>Ship Your Idea</h3>
                                            <span class="price"><span class="amount">£20.00</span></span>
                                        </a>
