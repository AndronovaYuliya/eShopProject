...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/page/bootstrap.css">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="shopping-item">
                    <a href="cart.php">Cart - <span class="cart-amunt">$000</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="single-product.php">Single product</a>
                </li>
                <li class="nav-item">
...
</div> <!-- End product-big-title-area -->
            ...
            <div class="col-md-4">
                ...
                <div class="single-sidebar">
                    ...
                    <div class="thubmnail-recent">
                        <img src="../../public/img/page/product-1.jpg" class="recent-thumb" alt="">
                            ...
                            <table cellspacing="0" class="shop_table cart">
                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        <a href="single-product.php"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="resources/img/product-thumb-2.jpg"></a>
                                    </td>
                                ...
                                <ul class="products">
                                    <li class="product">
                                        <a href="single-product.php">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="../../public/img/page/product-2.jpg">
                                    ...
                                    <li class="product">
                                        <a href="single-product.php">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="../../public/img/page/product-4.jpg">
                                            <h3>Ship Your Idea</h3>
                                            <span class="price"><span class="amount">£20.00</span></span>
                                        </a>
