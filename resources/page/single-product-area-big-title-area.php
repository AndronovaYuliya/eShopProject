                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                <h2 class="product-name">
                                    ...
                                    <?php if (count($data['product']) > 0): ?>
                                    <?php echo $data['product'][0]['title'] ?></h2>
                                <div class="product-inner-price">
                                    <ins>
                                        <?php echo $data['product'][0]['price'] . ' $'; ?>
                                    </ins>
                                    <del>
                                        <?php echo $data['product'][0]['price'] . ' $'; ?>
                                    </del>
                                ...
                                <form action="" class="cart">
                                    <div class="quantity">
                                        ...
                                        <?php if (($data['product'][0]['count']) == 0) echo 0; else echo 1; ?>"
                                               name="quantity" min="1"
                                               max="<?php echo($data['product'][0]['count']) ?>" step="1">
                                    </div>
                                    <button <?php if (($data['product'][0]['count']) == 0) echo 'disabled' ?>
                                ...
                                <?php if (count($data['products']) > 0): ?>
                                    <div class="product-inner-category">
                                        <p>Category: <a
                                                    href="/product/category?<?php echo $data['products'][0]['url_category'] ?>">
